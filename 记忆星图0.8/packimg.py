...
with open("logo.pdb","wb") as file:
    dic = {"logo.png":imga2ls(pygame.image.load("logo.png")),
           "logo2.png":imga2ls(pygame.image.load("logo2.png"))}
    pickle.dump(dic,file)
with open("main.pdb","wb") as file:
    dic = {}
    print("正在打包:  " + "4.png")
    dic["4.png"] = imga2ls(pygame.image.load("4.png"))
    print("正在打包:  " + "5.png")
    dic["5.png"] = imga2ls(pygame.image.load("5.png"))
    print("正在打包:  " + "6.png")
    dic["6.png"] = imga2ls(pygame.image.load("6.png"))
    print("正在打包:  " + "lock.png")
    dic["lock.png"] = imga2ls(pygame.image.load("lock.png"))
